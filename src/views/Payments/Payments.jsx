...
class Payments extends React.Component {
  ...
  async makePayment(address) {
    ...
    const transactionIndex = await this.contracts.PaymentPipe.methods.callUntrustedContractWithOnePercentTax.cacheSend(address, "paymentExample()", {from: this.props.accounts[0], value: amount, gasPrice: 10000000});
