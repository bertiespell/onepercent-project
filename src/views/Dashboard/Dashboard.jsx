...
class Dashboard extends React.Component {
  ...
  constructor(props, context) {
    super(props)
    this.globallyGenerated = context.drizzle.contracts.PaymentPipe.methods.totalFunds.cacheCall();
  }
  ...
  generateDashboardData() {
    ...
    this.globallyGenerated =  this.props.paymentPipeContract.totalFunds[this.context.drizzle.contracts.PaymentPipe.methods.totalFunds.cacheCall().toString()].value;
  }
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card>
              <CardHeader color="info" stats icon>
                ...
                <h3 className={classes.cardTitle}>
                {this.context.drizzle.web3.utils.fromWei(this.globallyGenerated).toString()}
                </h3>
              </CardHeader>
              <CardFooter stats>
                <div className={classes.stats}>
